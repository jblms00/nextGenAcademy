...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['model_comment_id']) && isset($_POST['logged_in_user_id'])) {
        ...
        $delete_comment_query = "DELETE FROM model_comments WHERE model_comment_id = '$commentId' AND user_id = '$loggedInUserId'";
